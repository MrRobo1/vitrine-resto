        ...
        <Card className="bg-foreground flex flex-col md:flex-row items-center gap-8 p-6 rounded-xl shadow-lg">
          ...
          <CardContent className="p-0 text-gray-300">
            ...
            <p className="mb-4">
              ...
              une œuvre d’art. Passionnés par les produits de saison et la cuisine française
              contemporaine, nous mettons à l’honneur le goût, la finesse et l’émotion culinaire.
            </p>
            <p>
              👨‍🍳 Notre chef, formé auprès des plus grandes maisons, allie tradition et créativité
              pour vous proposer une expérience gustative unique. Son savoir-faire et son exigence
              transforment chaque assiette en un moment d’exception.
            </p>
          </CardContent>
        </Card>
      </div>
